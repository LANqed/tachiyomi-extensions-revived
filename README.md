...
You can also directly download the APK files in this GitHub repository in the [`repo` branch](https://github.com/LANqed/tachiyomi-extensions-revived/tree/repo/apk).
